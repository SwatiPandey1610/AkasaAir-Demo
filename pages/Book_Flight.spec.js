...
export class Book_Flight {
    ...
    constructor(page) {
        ...
        this.pickdate = page.locator('body > div.MuiPickersPopper-root.css-1mtsuo7.MuiPopperUnstyled-root > div.MuiPaper-root.MuiPaper-elevation.MuiPaper-rounded.MuiPaper-elevation8.MuiPickersPopper-paper.css-a9rw36 > div > div > div > div.MuiPickersFadeTransitionGroup-root.MuiCalendarPicker-viewTransitionContainer.css-1h73gvd > div > div > div.PrivatePickersSlideTransition-root.MuiDayPicker-slideTransition.css-1cnkspq > div > div:nth-child(5) > div:nth-child(6) > button')
